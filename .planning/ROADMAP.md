...
Plans:
- [ ] 12-01-PLAN.md — Wave 0: rapidfuzz dep + schema/service stubs + migration 0015 (check-in cols + update_log) + main wiring + 10 red tests (Wave 1)
- [ ] 12-02-PLAN.md — Resolution engine: resolve_update (WRatio + intent) + POST /updates/resolve (UPDATE-02, UPDATE-03) (Wave 2)
- [ ] 12-03-PLAN.md — Check-in scheduler: PushoverClient url + checkin_service + schedule_checkin + /settings/check-in-time (NOTIF-07) (Wave 2)
